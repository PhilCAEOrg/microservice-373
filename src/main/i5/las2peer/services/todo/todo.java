...
public class todo extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "373", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-373/blob/master/LICENSE.txt") ) )
  @Path("/")
   ...
   *
   * 
   * @param payloadtodo  a JSONObject
   * 
   * @return Response 
   * 
   */
  ...
  public Response postTodo(String payloadtodo) {
    JSONObject payloadtodo_JSON = (JSONObject) JSONValue.parse(payloadtodo);
