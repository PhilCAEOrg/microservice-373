 ...
 * 373 - Test Class
 *
 * This class provides a basic testing framework for the microservice 373. It was
...
public class todoTest {
  ...
  public void testpostTodo() {
    ...
    try {
      JSONObject payloadtodo = new JSONObject();
      c.setLogin(testAgent.getIdentifier(), testPass);
      ClientResponse result = c.sendRequest("POST", mainPath + "/todo", payloadtodo.toJSONString(),
